...
Since you're here, I presume that you're trying to open an old document that
uses these fonts. Once you successfully install the font files, I'd recommend
that you convert the document to Unicode before doing anything else with it.
There is simply no guarantee that these font files will remain available long
term.
